...
const Navbar = () => {
  ...
  return (
    <nav className="top-0 left-0 right-0 z-50 backdrop-blur-lg bg-white/11 border-b border-slate-200 dark:border-slate-700 px-8 py-1">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center space-x-8">
          <div className="flex items-center gap-2">
            {/* Artisan-styled logo with animation */}
            <div className="relative h-16 w-16 rounded-full flex items-center justify-center overflow-hidden">
            ...
            <span className="font-serif text-3xl font-semibold bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">
              Artisan Directory
            </span>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <Button
              ...
              className={`gap-2 ${
                !isActive("/reports") &&
                "hover:bg-gradient-to-r hover:from-orange-50 hover:to-yellow-50 dark:hover:from-orange-900/20 dark:hover:to-yellow-900/20"
              }`}
            ...
            <Button
              ...
              className={`gap-2 ${
                !isActive("/manage") &&
                "hover:bg-gradient-to-r hover:from-red-50 hover:to-orange-50 dark:hover:from-red-900/20 dark:hover:to-orange-900/20"
              }`}
        ...
        <div className="flex items-center space-x-4">
          ...
          >
            ...
            <span className="absolute inset-0 rounded-full bg-gradient-to-r from-indigo-500/10 to-purple-500/10 opacity-0 hover:opacity-100 transition-opacity" />
          </Button>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent
              align="end"
              className="w-56 p-1 border border-slate-200 dark:border-slate-700"
            >
